...
import {
  ...
  Clock, LayoutDashboard, Eye, Moon, Sun, Settings as SettingsIcon, Brain, Route, RefreshCw
} from 'lucide-react'
...
const nav = [
  ...
  { to: '/smart-router', label: 'Smart Router', icon: Route },
  { to: '/consistency', label: 'Consistency', icon: RefreshCw },
